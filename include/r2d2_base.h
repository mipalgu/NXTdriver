...
/**
 ...
 r2d2mipal is a C++ library for programming Lego NXT robots using either the USB or the Bluetooth interfaces.
 It supports Linux, Microsoft Windows (tested on 7) and Mac OS X. This version is adapted from Esteve Fernandez
 git-hub release so it works in Debian and Ubuntu,  and also to compile and fir the ROS/catkin format of
 a catkin_package by Vlad Estivill-Castro (other contributors include Rene Hexel).

 \section requirements Requirements

 catkin (http://catkin-tools.readthedocs.org/en/latest/index.html)
 r2d2-nxt uses certain C++11 features, so you'll need a relatively recent C++ compiler.
 r2d2-nxt has been tested on the following platforms:

 - Ubuntu 14.04  ROS-Indigo/ROS-Hydro
 - MacOS Mavericks  ROS-Hydro

 You will also need to have libusb-1.0 installed (http://libusb.org). 
 If you want to generate the documentation, you'll also have to install Doxygen
 (http://doxygen.org) and Graphviz (http://graphviz.org)

 \section install_sec Installation

 Place the package in the <tt> src </tt> folder of a <tt> catkin</tt> workspace.
 Run <tt>catkin make</tt> to generate the library and the test program.

 \section examples Examples

 There is one example program. Its called <tt>test.cpp</tt> and after compilation it is placed
 in <tt> devel/lib/r2d2mipal/testDemo </tt>

 To run in bluetooth mode add <tt>-b some_number</tt>

 If your NXT is connected by a USB cable, place no option.
...
/**
An un-configured NXT brick, without any sensors or motors attached.

An un-configured NXT brick can issue system commands such as Brick::getFirmware
